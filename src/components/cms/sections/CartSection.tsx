          ...
          <div className="border border-[var(--border)] rounded-[var(--radius-lg)] p-6 self-start h-auto">
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span>{shipping === 0 ? (onSave && isEditable ? <EditableText value={getLocalizedString(props.shippingFreeLabel, locale) || ''} onSave={(val) => onSave(block.id, 'props.shippingFreeLabel', val)} isEditable={isEditable} tag="span" placeholder="Free..." /> : getLocalizedString(props.shippingFreeLabel, locale)) : `$${shipping.toFixed(2)}`}</span>
              </div>
